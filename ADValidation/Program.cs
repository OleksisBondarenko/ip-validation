...
string CURRENT_URL = builder.Configuration["Urls"];
...
//                             string cspMetaTag =
//                                 $"<meta http-equiv=\"Content-Security-Policy\" content=\"script-src 'self' 'unsafe-inline' 'nonce-{randomNonceValue}' {string.Join(' ', ASSETS_URLS)};\">";
...
//                             string scriptTag = $"<script nonce={randomNonceValue} src='{CURRENT_URL}/scripts/myScript.js'></script>";
